...
(function(module) {
  ...
  function wordCount(){
    return count = Article.body.split(' ').length;
  };
  ...
  Article.prototype.insertRecord = function (callback) {
    ...
    // RESPONSE: JavaScript will not allow you to make a constructor with an arrow function because they have lexical scope, therefore do not create their own scope and do not understand contextual this. Arrow functions have no prototype property.
